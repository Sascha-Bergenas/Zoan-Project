...
export function SessionsProvider({ children }: {children: React.ReactNode}) {
    ...
    const actions: SessionsContextValue["actions"] = {
        ...
        async save(newSession) {
            ...
            try {
                await saveSession(user.id, newSession) // TODO: Ersätt user_id med det från auth
                console.log("Saving...");
                setStatus({type: "isOk"})
        ...
        async update(sessionData) {
            ...
            try {
                await updateSession(user.id, sessionData) // TODO: Ersätt user_id med det från auth
                setStatus({type: "isOk"})
