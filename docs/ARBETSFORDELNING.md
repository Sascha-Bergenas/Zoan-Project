...
| namn                                                  | Ansvarsområde                                                                                                                                                                                 |
| ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Sascha Bergenås](https://github.com/Sascha-Bergenas) | Dashboard, Todo, SettingsPage, Återanvändbara komponenter, SessionModal, WorkSessionForm, Grafer i history, Kalender, Vitest-testing i SettingsPage, CSS-Styling - SettingPage i React Native |
